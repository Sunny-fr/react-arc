...
var ReduxActionsList = exports.ReduxActionsList = function () {
    ...
    _createClass(ReduxActionsList, [{
        ...
        value: function standAloneFetchOne(params, config, props) {
            return this.axios({
        ...
        value: function fetchOne() {
            ...
            return function (dispatch) {
                ...
                _this4.standAloneFetchOne(params, config, props).then(function (response) {
                    dispatch({
        ...
        value: function standAloneFetchAll(params, config, props) {
        ...
        value: function fetchAll() {
            ...
            return function (dispatch) {
                ...
                _this7.standAloneFetchAll(params, config, props).then(function (response) {
                    dispatch({
