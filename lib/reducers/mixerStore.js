...
function mixerStore(options) {
    ...
    function keyGen(params) {
        return params ? (0, _ReduxActionsList.interpolate)(null, params) : null;
    }
    ...
    return function reducer() {
        ...
        function decorate(str) {
            return (0, _ReduxActionsList.interpolate)(str, config);
        }
            ...
            case decorate('FETCH_{uppercaseName}'):
                {
                    ...
                    if (!state.collection[key]) {
                        newState.collection[key] = _extends({}, defaultModel, { metas: _extends({}, defaultModel.metas, { fetching: true }) });
                    } else {
            ...
            case decorate('FETCH_{uppercaseName}_FULFILLED'):
                {
                    ...
                    _collection[_key2] = { metas: { loaded: true, fetching: false, valid: true }, model: action.payload.data };
                    return _extends({}, state, {
            ...
            case decorate('EDIT_{uppercaseName}'):
                {
                    ...
                    if (!_key3) {
                        ...
                        _collection2[_key3].model = Object.assign({}, _collection2[_key3].model, action.payload.data);
                        return _extends({}, state, {
            ...
            case decorate('SAVE_{uppercaseName}'):
                {
                    ...
                    var updated = _extends({}, prev, { metas: _extends({}, prev.metas, { saving: true }) });
                    if (!_key4) {
                        //model is new
                        return _extends({}, state, { temp: updated });
                    } else {
                        var _collection3 = update(updated, _key4);
                        return _extends({}, state, { collection: _collection3 });
                    }
                }
            ...
            case decorate('SAVE_{uppercaseName}_REJECTED'):
                {
                    ...
                    if (!_key5) {
                        ...
                        var _collection4 = update(_updated, _key5);
                        return _extends({}, state, {
            ...
            case decorate('SAVE_{uppercaseName}_FULFILLED'):
                {
                    ...
                    if (!_key6) {
                        ...
                        var _collection5 = update(_updated2, _key6);
                        return _extends({}, state, {
            ...
            case decorate('DELETE_{uppercaseName}'):
                {
                    ...
                    var _collection6 = update(_updated3, _key7);
            ...
            case decorate('DELETE_{uppercaseName}_REJECTED'):
                {
                    ...
                    var _collection7 = update(_updated4, _key8);
                    return _extends({}, state, {
            ...
            case decorate('DELETE_{uppercaseName}_FULFILLED'):
                {
                    ...
                    var _collection8 = _extends({}, state.collection);
                    delete _collection8[_key9];
                    return _extends({}, state, {
