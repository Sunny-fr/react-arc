...
function mixerStore(options) {
  ...
  var defaultState = {
    collection: {},
    temp: {
      metas: _extends({}, defaultMetaModel.metas),
      model: _extends({}, defaultMetaModel.model)
    },
    fetching: false,
    loaded: false,
    error: null
  ...
  function mapModels(list) {
    return list.reduce(function (prev, current) {
      ...
      prev[key] = Object.assign({}, defaultMetaModel, {
        model: current,
        metas: _extends({}, defaultMetaModel.metas, { loaded: true, valid: true })
      });
      return prev;
    }, {});
  }
      ...
      case decorate("RESET_{uppercaseName}S"):
        {
          return _extends({}, defaultState, {
            ...
            temp: {
              metas: _extends({}, defaultMetaModel.metas, { loaded: false }),
              model: _extends({}, defaultMetaModel.model)
            }
          });
        }
      ...
      case decorate("FETCH_{uppercaseName}"):
        {
          ...
          if (!_previous) {
            _collection[_key] = _extends({}, defaultMetaModel, {
              metas: _extends({}, defaultMetaModel.metas, {
                error: null,
                fetching: true,
                start: time(),
      ...
      case decorate("RESET_{uppercaseName}_TEMP"):
        {
          return _extends({}, state, {
            temp: {
              metas: _extends({}, defaultMetaModel.metas, { loaded: true }),
              model: _extends({}, defaultMetaModel.model)
            }
          });
        }
