            ...
            case decorate('FETCH_{uppercaseName}'):
                {
                    ...
                    if (!collection[key]) {
                        ...
                        collection[key] = Object.assign({}, collection[key], {
                            metas: _extends({}, collection[key].metas, {
                                fetching: true,
                                saved: false
                            })
                        });
            ...
            case decorate('FETCH_{uppercaseName}_REJECTED'):
                {
                    ...
                    _collection[_key] = {
                        metas: _extends({}, _collection[_key].metas, { loaded: false, fetching: false, valid: false, error: action.payload.error }),
            ...
            case decorate('FETCH_{uppercaseName}_FULFILLED'):
                {
                    ...
                    _collection2[_key2] = { metas: _extends({}, _collection2[_key2].metas, { loaded: true, fetching: false, valid: true }), model: action.payload.data };
                    return _extends({}, state, {
            ...
            case decorate('SAVE_{uppercaseName}'):
                {
                    ...
                    var prev = action.payload.create ? state.temp : previousItem(_key4);
                    var updated = _extends({}, prev, { metas: _extends({}, prev.metas, { error: null, saving: true, saved: false }) });
            ...
            case decorate('SAVE_{uppercaseName}_REJECTED'):
                {
                    ...
                    var _prev = action.payload.create ? state.temp : previousItem(_key5);
                    var _updated = _extends({}, _prev, { metas: _extends({}, _prev.metas, { error: action.payload.error, saving: false, saved: false }) });
                    if (action.payload.create) {
                        //model is new
            ...
            case decorate('SAVE_{uppercaseName}_FULFILLED'):
                {
                    ...
                    var _prev2 = action.payload.create ? state.temp : previousItem(_key6);
                    var _updated2 = _extends({}, _prev2, {
                        metas: _extends({}, _prev2.metas, { saving: false, saved: true }),
            ...
            case decorate('DELETE_{uppercaseName}'):
                {
                    ...
                    var _updated3 = _extends({}, _prev3, { metas: _extends({}, _prev3.metas, { deleting: true, fetching: true }) });
            ...
            case decorate('DELETE_{uppercaseName}_REJECTED'):
                {
                    ...
                    var _updated4 = _extends({}, _prev4, { metas: _extends({}, _prev4.metas, { error: action.payload.error, deleting: false, fetching: false }) });
