            ...
            case decorate('FETCH_{uppercaseName}'):
                {
                    ...
                    if (!collection[key]) {
                        collection[key] = _extends({}, defaultModel, { metas: _extends({}, defaultModel.metas, { fetching: true, start: time() }) });
                    } else {
            ...
            case decorate('EDIT_{uppercaseName}'):
                {
                    ...
                    if (!_key3) {
                        ...
                        _collection3[_key3] = {
                            ...
                            model: Object.assign({}, _collection3[_key3].model, action.payload.data)
                        };
                        return _extends({}, state, {
