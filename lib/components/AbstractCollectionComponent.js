...
var AbstractCollectionComponent = exports.AbstractCollectionComponent = function (_AbstractComponent) {
    ...
    function AbstractCollectionComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AbstractCollectionComponent.__proto__ || Object.getPrototypeOf(AbstractCollectionComponent)).call.apply(_ref, [this].concat(args))), _this), _this.fetch = function (props) {
            _this.props.dispatch(_this.actions.fetchAll((0, _utils.extractParams)(_this.ARCConfig.collectionProps, props || _this.props)));
            ...
            return !(_this.ARCConfig.fetchOnce && _this.isLoaded(props || _this.props));
