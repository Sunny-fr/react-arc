...
var AbstractModelComponent = exports.AbstractModelComponent = function (_AbstractComponent) {
    ...
    _createClass(AbstractModelComponent, [{
        ...
        value: function _canUpdate(_props) {
            ...
            //console.log(this.getKey(props),'is new',this.isNew(props), 'is loaded',this.isCollectionLoaded(props), 'is fetching', this.isCollectionSyncing(props), 'issued',  this.getCollectionError(props))
