...
var AbstractModelComponent = exports.AbstractModelComponent = function (_AbstractComponent) {
    ...
    function AbstractModelComponent() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AbstractModelComponent.__proto__ || Object.getPrototypeOf(AbstractModelComponent)).call.apply(_ref, [this].concat(args))), _this), _this.getParams = function (props) {
