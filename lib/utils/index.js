...
function interpolate(str, params) {
    ...
    var result = keys.sort().reduce(function (prev, current) {
        ...
        if (elm_val !== null && (typeof elm_val === 'undefined' ? 'undefined' : _typeof(elm_val)) === 'object' && Array.isArray(elm_val) === false) {
