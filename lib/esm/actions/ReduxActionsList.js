...
function errorSerializer(error) {
    if (error && error.response) {
        return "Error: ".concat(error.message, ", Response: ").concat(JSON.stringify(error.response.data));
    }
    return "Error: ".concat(error.message);
}
export var AXIOS_CANCEL_PAYLOAD = {
    code: "ERR_CANCELED",
    name: "CanceledError"
};
var ReduxActionsList = /** @class */ (function () {
    ...
    ReduxActionsList.prototype.edit = function (data, params) {
        ...
        return function (dispatch) {
            dispatch({
                type: _this.decorate(ACTIONS.EDIT),
    ...
    ReduxActionsList.prototype.fetchOne = function (params, props, axiosOptions) {
        ...
        return function (dispatch) {
            ...
            var applyRequest = function (tryNumber) {
                ...
                var actionType = _this.decorate(ACTIONS.FETCH);
                dispatch({
                    type: actionType,
                    payload: {
                        params: params,
                ...
                return _this.standAloneFetchOne(params, config, props, axiosOptions)
                    ...
                    dispatch({
                        type: _this.decorate(ACTIONS.FETCH_FULFILLED),
                    ...
                    if (error && error.code === AXIOS_CANCEL_PAYLOAD.code && error.name === AXIOS_CANCEL_PAYLOAD.name) {
                        dispatch({
                            type: _this.decorate(ACTIONS.FETCH_CANCELLED),
                            payload: {
                    ...
                    dispatch({
                        type: _this.decorate(ACTIONS.FETCH_REJECTED),
                        payload: {
                            error: errorSerializer(error),
                            params: params
                        },
    ...
    ReduxActionsList.prototype.save = function (data, params, create, props) {
        ...
        return function (dispatch) {
            ...
            return _this.standAloneSave(data, params, create, config, props)
                ...
                .catch(function (error) {
                dispatch({
                    type: _this.decorate(ACTIONS.SAVE_REJECTED),
                    payload: {
                        error: errorSerializer(error),
                        data: data,
                        params: params,
    ...
    ReduxActionsList.prototype.remove = function (params, props) {
        ...
        return function (dispatch) {
            var config = _this.beforeFetch({ config: _this.config, params: params, props: props });
            dispatch({
                type: _this.decorate(ACTIONS.DELETE),
                payload: { params: params },
            });
            return _this.standAloneRemove(params, config, props)
                .then(function (response) {
                dispatch({
                    type: _this.decorate(ACTIONS.DELETE_FULFILLED),
                ...
                .catch(function (error) {
                dispatch({
                    type: _this.decorate(ACTIONS.DELETE_REJECTED),
                    payload: {
                        error: errorSerializer(error),
                        params: params
                    },
    ...
    ReduxActionsList.prototype.resetTemp = function () {
        var _this = this;
        return function (dispatch) {
            dispatch({ type: _this.decorate(ACTIONS.RESET) });
        };
    };
