...
export function useModelContainer({ ARCConfig, props }) {
     ...
     */
    const getModel = useCallback((componentProps) => {
     ...
     */
    const getError = useCallback((componentProps) => {
     ...
     */
    const isSyncing = useCallback((componentProps) => {
     ...
     */
    const isLoaded = useCallback((componentProps) => {
     ...
     */
    const isNew = useCallback((componentProps) => {
     ...
     */
    const getKey = useCallback((componentProps) => {
     ...
     */
    const getParams = useCallback((componentProps) => {
     ...
     */
    const hasRequiredParams = useCallback((componentProps) => {
     ...
     * @returns The model data
     */
    const _getModel = useCallback((componentProps) => {
     ...
     */
    const getMetas = useCallback((prop, componentProps) => {
     ...
     */
    const allowReFetch = useCallback((componentProps) => {
     ...
     */
    const errorReFetch = useCallback((componentProps) => {
     ...
     */
    const _fetchAuthorization = useCallback((componentProps, { skipReFetchStep = false }) => {
...
export function ModelContainer(props) {
    ...
    const { isLoaded, isSyncing, getError, getModelDataTyped, getParams, fetch } = modelContainer;
    ...
    return (React.createElement(Component, { ...componentProps, loading: loading, loaded: loaded, model: data, error: error, fetch: () => fetch(params) }));
}
