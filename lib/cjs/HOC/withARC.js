...
function connectFn(config) {
    return function (store, ownProps) {
        ...
        var isNew = !modelKey;
        return __assign(__assign({}, mergedProps), { ARCConfig: config, loaded: loaded, metaModel: metaModel, model: model, error: error, syncing: syncing, metas: metas, isNew: isNew });
    };
}
/**
 *
