 ...
 * @param selectors
 */
function connectFn(config, selectors = []) {
...
function withARC(config, selectors = []) {
    ...
    function createHOC(Wrapped) {
        ...
        const Connector = (0, react_redux_1.connect)(connectFn(extendedConfig, selectors))(Wrapped);
