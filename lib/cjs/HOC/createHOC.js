...
function createHOC({ Container = ModelContainer_1.ModelContainer, ARCConfig, selectors = [] }) {
    return function GeneratedHOC(Wrapped) {
        const GeneratedARCContainer = (0, withARC_1.withARC)(ARCConfig, selectors)(Container);
