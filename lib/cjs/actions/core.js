...
props, listOfParams, rootState) {
    ...
    listOfParams.forEach(function (keyProps) {
        ...
        var metaModel = (0, selectors_1.metaModelSelector)(rootState, config, modelKey);
 ...
 */
function freeModelPicker(config, rootState, listOfParams) {
    if (listOfParams === void 0) { listOfParams = []; }
    return (modelPicker(config, {}, listOfParams, rootState) || []).filter(Boolean);
}
/**
