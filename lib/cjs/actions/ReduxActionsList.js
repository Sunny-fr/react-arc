...
exports.ReduxActionsList = void 0;
...
var ReduxActionsList = /** @class */ (function () {
    function ReduxActionsList(options) {
        ...
        this.config = __assign(__assign({}, (0, utils_1.getDefaultConfig)()), (options.config || {}));
    ...
    ReduxActionsList.GenerateCancelToken = function (axiosOptions) {
        return new axios_1.default.CancelToken(function executor(c) {
            if (axiosOptions) {
    ...
    ReduxActionsList.prototype.generateCancelToken = function (axiosOptions) {
        return new axios_1.default.CancelToken(function executor(c) {
            if (axiosOptions) {
                axiosOptions.cancel = c;
            }
...
exports.ReduxActionsList = ReduxActionsList;
