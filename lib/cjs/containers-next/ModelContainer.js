...
function useModelContainer(_a) {
    ...
    var getFetchingCount = (0, react_1.useCallback)(function () {
        return (0, selectors_1.fetchingCountSelector)(reduxContext === null || reduxContext === void 0 ? void 0 : reduxContext.store.getState(), ARCConfig);
    }, [ARCConfig]);
    /**
    ...
    var _fetchAuthorization = (0, react_1.useCallback)(function (componentProps, _a) {
        ...
        var metaModel = (0, selectors_1.metaModelSelector)(reduxContext === null || reduxContext === void 0 ? void 0 : reduxContext.store.getState(), ARCConfig, modelKey);
