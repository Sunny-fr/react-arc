...
function useModelContainer({ ARCConfig, props }) {
    ...
    const getFetchingCount = (0, react_1.useCallback)(() => {
        return (0, selectors_1.fetchingCountSelector)(reduxContext?.store.getState(), ARCConfig);
    }, [ARCConfig]);
    /**
...
function ModelContainer(props) {
    ...
    return (react_1.default.createElement(Component, { ...componentProps, loading: loading, loaded: loaded, model: data, error: error, fetch: () => fetch(params) }));
}
