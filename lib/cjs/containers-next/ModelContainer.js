...
function useModelContainer(_a) {
    var ARCConfig = _a.ARCConfig, initialProps = _a.props;
    var dispatch = (0, react_redux_1.useDispatch)();
    var container = (0, Container_1.useContainer)({ ARCConfig: ARCConfig });
    var actions = container.actions, core = container.core, abortControllerRef = container.abortController, getPropsFromTrueStoreState = container.getPropsFromTrueStoreState;
    var delayedTimeoutRef = (0, react_1.useRef)(undefined);
    var props = getPropsFromTrueStoreState(initialProps);
    var isMountedRef = (0, react_1.useRef)(true); // Reference to track if the component is mounted
     ...
     */
    var getModel = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var getError = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var isSyncing = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var isLoaded = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var isNew = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var getKey = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var getParams = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var hasRequiredParams = (0, react_1.useCallback)(function (componentProps) {
     ...
     * @returns The model data
     */
    var _getModel = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var getMetas = (0, react_1.useCallback)(function (prop, componentProps) {
     ...
     */
    var resetTempModel = (0, react_1.useCallback)(function () {
     ...
     */
    var edit = (0, react_1.useCallback)(function (model) {
     ...
     */
    var getFetchingCount = (0, react_1.useCallback)(function () {
        var collection = getPropsFromTrueStoreState(props).collection;
        return core.getFetchingCount(__assign(__assign({}, props), { collection: collection }));
     ...
     */
    var allowReFetch = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var errorReFetch = (0, react_1.useCallback)(function (componentProps) {
     ...
     */
    var _fetchAuthorization = (0, react_1.useCallback)(function (componentProps, _a) {
        var _b = _a.skipReFetchStep, skipReFetchStep = _b === void 0 ? false : _b;
        var reducerState = container.getTrueStoreState();
     ...
     */
    var getModelDataTyped = (0, react_1.useCallback)(function () {
        var loaded = isLoaded();
        var error = getError();
    ...
    var prepareFetch = (0, react_1.useCallback)(function (_a) {
        ...
        var currentProps = getPropsFromTrueStoreState(props);
        if (_fetchAuthorization(currentProps, { skipReFetchStep: skipReFetchStep })) {
            ...
            var params = getParams(currentProps);
            if (!params) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        return function () {
            ...
            if (abortControllerRef.current && fetchStatus.inProgress) {
                ...
                abortControllerRef.current.abort(commons_1.default.cancelRequestPayload({ ARCConfig: ARCConfig }));
    ...
    return __assign(__assign({}, container), { isNew: isNew, getKey: getKey, getParams: getParams, hasRequiredParams: hasRequiredParams, _getModel: _getModel, fetch: fetch, edit: edit, save: save, remove: remove, resetTempModel: resetTempModel, getFetchingCount: getFetchingCount, getModel: getModel, getMetas: getMetas, getError: getError, isSyncing: isSyncing, isLoaded: isLoaded, allowReFetch: allowReFetch, errorReFetch: errorReFetch, getModelDataTyped: getModelDataTyped, prepareFetch: prepareFetch });
}
function ModelContainer(props) {
    ...
    var componentProps = (0, utils_1.omit)(props, ['ARCConfig', 'component']);
    var loaded = isLoaded();
    ...
    return (react_1.default.createElement(Component, __assign({}, componentProps, { loading: loading, loaded: loaded, model: data, error: error, fetch: function () { return fetch(params); } })));
}
