...
var ModelContainer = /** @class */ (function (_super) {
    ...
    function ModelContainer() {
        ...
        _this.save = function () {
            ...
            var extracted = (0, utils_1.getParams)(_this.ARCConfig, _this.props);
        ...
        _this.allowReFetch = function (props) {
            var reducerState = (props || _this.props).ARCReducerState;
            return _this.core.allowReFetch(_this.ARCConfig, props || _this.props, reducerState);
        };
        return _this;
    ...
    ModelContainer.prototype._getModel = function (props) {
        var reducerState = (props || this.props).ARCReducerState;
    ...
    ModelContainer.prototype._fetchAuthorization = function (props, _a) {
        var _b = _a.skipReFetchStep, skipReFetchStep = _b === void 0 ? false : _b;
        var reducerState = props.ARCReducerState;
        if (this.isNew(props)) {
    ...
    ModelContainer.prototype.render = function () {
        ...
        var props = __assign({}, (0, utils_1.omit)(this.props, ['ARCConfig', 'ARCReducerState', 'component']));
        var loaded = this.isLoaded();
        ...
        return (react_1.default.createElement(Component, __assign({}, props, { loading: loading, loaded: loaded, model: data, error: error, fetch: function () { return _this.fetch(params); } })));
    };
