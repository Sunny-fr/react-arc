...
var ModelContainer = /** @class */ (function (_super) {
    ...
    function ModelContainer() {
        ...
        _this.fetch = function (params) {
            ...
            promise.catch(function (e) {
                if (e.name === ReduxActionsList_1.AXIOS_CANCEL_PAYLOAD.name && e.code === ReduxActionsList_1.AXIOS_CANCEL_PAYLOAD.code) {
                    //console.warn('ModelContainer: fetch aborted', e)
                    return;
                }
                return Promise.reject({
                    message: 'Fetch error',
                    ARCConfig: _this.ARCConfig,
                    error: e,
                });
            });
            return promise;
    ...
    ModelContainer.prototype.render = function () {
        ...
        var props = __assign({}, (0, utils_1.omit)(this.props, ['ARCConfig', 'component']));
        var loaded = this.isLoaded();
