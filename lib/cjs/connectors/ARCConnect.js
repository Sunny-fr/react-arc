...
function ARCConnect(config) {
    return function (store, ownProps) {
        ...
        return __assign(__assign({}, (0, utils_1.extendWithDefaultProps)(config, ownProps)), { ARCConfig: config, loaded: loaded, metaModel: metaModel, model: model, error: error, fetching: syncing, syncing: syncing, metas: metas, isNew: isNew, temp: store[namespace].temp, collection: collection });
    };
}
exports.ARCConnect = ARCConnect;
