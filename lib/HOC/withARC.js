...
var connectFn = exports.connectFn = function connectFn(ARCConfig) {
  return function (store, ownProps) {
    ...
    var mergedProps = _extends({}, (0, _utils.getDefaultFromMissingProps)(ARCConfig, ownProps), (0, _utils.removeMissingProps)(ownProps), arcProps);
    ...
    return _extends({
      ...
      syncing: syncing,
      metas: metas
    }, (0, _utils.getDefaultFromMissingProps)(ARCConfig, ownProps));
  };
};
