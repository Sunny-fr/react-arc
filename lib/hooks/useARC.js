...
var _utils = require('../../demo/src/lib/utils');
...
var ARC = function () {
    ...
    _createClass(ARC, [{
        ...
        value: function get(_ref2) {
            ...
            return fetch((0, _utils.interpolate)(this.config.paths.item, p), {
        ...
        value: function extendConfig(ARCConfig) {
            return _extends({}, _defaultConfig2.default, ARCConfig || {});
        }
    }, {
        key: 'extendHeaders',
...
function useARC(_ref6) {
    ...
    var handle = function handle(fetcher) {
        ...
        setState(_extends({}, state, { error: null, loaded: false, loading: true, response: null }));
        return fetcher().then(function (r) {
            setState(_extends({}, state, { loaded: true, error: null, loading: false, response: r }));
            return r;
        }).catch(function (r) {
            setState(_extends({}, state, { error: r.message || r, loading: false }));
            return Promise.reject(r);
        });
    };
    ...
    return {
        ...
        extract: function extract(props) {
            return arc.extractParams(props);
        },
        ...
        get: function get(_ref7) {
            ...
            return handle(function () {
                return arc.get({ props: props, params: params });
            });
        },
        remove: function remove(_ref8) {
            var props = _ref8.props,
                params = _ref8.params;
            return handle(function () {
                return arc.remove({ props: props, params: params });
            });
        },
        create: function create(_ref9) {
            var props = _ref9.props,
                ...
                body = _ref9.body;
            return handle(function () {
                return arc.create({ props: props, params: params, body: body });
            });
        },
        update: function update(_ref10) {
            var props = _ref10.props,
                ...
                body = _ref10.body;
            return handle(function () {
                return arc.update({ props: props, params: params, body: body });
            });
        }
    };
}