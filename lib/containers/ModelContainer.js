...
var ModelContainer = exports.ModelContainer = function (_Container) {
  ...
  _createClass(ModelContainer, [{
    ...
    value: function isNew(props) {
      // ENSURE EXISTENCE
      return (props || this.props).isNew || this.core.isNew(this.ARCConfig, props || this.props);
    }
    ...
    value: function _getModel(props) {
      // ENSURE EXISTENCE
      return (props || this.props).metaModel || this.core._getModel(this.ARCConfig, props || this.props);
    }
    ...
    value: function getModel(props) {
      // ENSURE EXISTENCE
      return (props || this.props).model || this.core.getModel(this.ARCConfig, props || this.props);
    }
    ...
    value: function getMetas(prop, props) {
      var metas = (props || this.props).metas || this.core.getMetas(this.ARCConfig, undefined, props || this.props);
    ...
    value: function getError(props) {
      return (props || this.props).error || this.core.getError(this.ARCConfig, props || this.props);
    }
    ...
    value: function isSyncing(props) {
      return (props || this.props).syncing || this.core.isSyncing(this.ARCConfig, props || this.props);
    }
    ...
    value: function isLoaded(props) {
      return (props || this.props).loaded || this.core.isLoaded(this.ARCConfig, props || this.props);
    }
    ...
    value: function _fetchAuthorization(props, _ref4) {
      ...
      if (typeof this._getModel(props) === "undefined" || typeof this.core._getModel(this.ARCConfig, props) === "undefined") {
      ...
      if (!skipReFetchStep && (this.isLoaded(props) || this.core.isLoaded(this.ARCConfig, props)) && this.allowReFetch(props)) {
        //console.log('//model seems to be loaded but its ok to re-fetch it')
        return true;
      }

      if (!skipReFetchStep && (!!this.getError(props) || !!this.core.getError(this.ARCConfig, props)) && this.errorReFetch(props)) {
