...
var ARCConnector = exports.ARCConnector = function ARCConnector(connect, config) {
  ...
  return connect(function (store, ownProps) {
    ...
    var mergedProps = _extends({}, (0, _utils.extendWithMissingDefaultProps)(ARCConfig, ownProps), ownProps, arcProps);
    ...
    var mapStateToProps = function mapStateToProps(store) {
      return _extends({
        ...
        error: error,
        syncing: syncing
      }, (0, _utils.extendWithMissingDefaultProps)(ARCConfig, ownProps));
    };
